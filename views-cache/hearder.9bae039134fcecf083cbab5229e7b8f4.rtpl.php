        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="/res/site/login"><i class="fa fa-user"></i> Minha Conta</a></li>
                            <li><a href="#"><i class="fa fa-heart"></i> Lista de Desejos</a></li>
                            <li><a href="/res/site/carrinho.html"><i class="fa fa-shopping-cart"></i> Meu Carrinho</a></li>
                            <li><a href="/res/site/login.html"><i class="fa fa-lock"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/res/site/lista-produtos.html">Produtos</a></li>
                    <li><a href="/res/site/carrinho.html">Carrinho</a></li>
                </ul>
            </div>  
        </div>
    </div>
